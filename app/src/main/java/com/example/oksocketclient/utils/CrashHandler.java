...
//            upToServer("crash-" + time + "-" + timestamp + "-chengguan", sb.toString());
            return fileName;
        } catch (Exception e) {
...
//     * 上传崩溃日志
//     */
//    private void upToServer(String name, String content) {
//        HttpUtils httpUtils = new HttpUtils();
//        String url = "http://applog.jndv.org/Code/Clog.ashx";
//        RequestParams params = new RequestParams();
//        params.addBodyParameter("Fname", name);//文件名
//        params.addBodyParameter("Fctnt", content);//文件内容
...
//    }
    ...
    private void catchNomalLogToFile() {
        String logName = Environment.getExternalStorageDirectory() + "/crash/" + System.currentTimeMillis() + "_crash_log.log";
        Log.e(TAG, "Catching log to  " + logName);
